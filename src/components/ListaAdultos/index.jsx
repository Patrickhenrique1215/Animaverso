...
function ListaAdultos() {
  ...
  useEffect(() => {
    const fetchAnimacoesAdultos = async () => {
      try {
        ...
        setAnimacoesAdultos(todasAnimacoesAdultos);
      } catch (error) {
  ...
  //Render condicional
  if (loading) {
    return <section className={styles.listaAdultos}>Carregando...</section>;
  }
