...
function ListaFamilia() {
  ...
  //useEffect para esconder e mostrar seta a esquerda
  useEffect(() => {
  ...
  //useEffect para buscar animaçoes FAMILIA
  useEffect(() => {
  ...
  return (
    ...
    <section ref={containerRef} onScroll={checkScroll} className={styles.listaFamilia}>
