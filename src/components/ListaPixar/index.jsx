...
function ListaPixar() {
  ...
  //useEffect para mostrar e esconder a serta a esquerda
  useEffect(() => {
  ...
  //useEffect para buscar animaçoes PIXAR
  useEffect(() => {
  ...
  return (
    ...
    <section ref={containerRef} onScroll={checkScroll} className={styles.listaPixar}>
